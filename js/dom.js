...
function createBook(idBook, inputBookTitle, inputBookAuthor, inputBookYear, inputBookIsComplete) {
    ...
    cardContainer.classList.add("card-body", "border-start", "border-5", "border-danger", "d-flex", "justify-content-between");
    ...
    cardContent.append(`Judul Buku : `, bookTitle, `Penulis : `, bookAuthor, br, `Tahun terbit : `, bookYear);
...
function createActionDelete(idBook) {
    ...
    actionDelete.innerHTML = '<i class="fa fa-trash"> Hapus Buku</i>';
...
function createActionEdit(idBook) {
    ...
    actionEdit.classList.add("btn", "btn-sm", "btn-outline-info", "mx-1");
    actionEdit.innerHTML = '<i class="fa fa-edit"> edit Buku</i>';
...
function createActionRead(idBook) {
    ...
    action.innerHTML = '<i class="fa fa-check"> Selesai Dibaca </i>';
...
function createActionUndo(idBook) {
    ...
    action.innerHTML = '<i class="fa fa-undo"> Masih di baca</i>';
